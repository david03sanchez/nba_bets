...
for r in range(0,len(complete_dataset)):
    print(r)
    if (pd.to_datetime(complete_dataset[r][0]) < '2019-01-01').bool():
...
param = {'max_depth': 7, 'eta': .03, 'objective': 'reg:pseudohubererror'}
...
home_stats = scoring_object.get_latest_stats('WAS','2021-11-07')
away_stats = scoring_object.get_latest_stats('MIL','2021-11-07')
